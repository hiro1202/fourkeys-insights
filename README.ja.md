...
| **デプロイ頻度** | 1日あたりのPRマージ数（マージ=デプロイとして扱う） |
| **変更失敗率** | インシデントルールに一致するPRの割合 |
| **平均復旧時間 (MTTR)** | インシデントPRのリードタイム中央値 |
...
- **リードタイム開始点の選択** - 最初のコミット / リンクされたIssue作成日 / PR作成日
